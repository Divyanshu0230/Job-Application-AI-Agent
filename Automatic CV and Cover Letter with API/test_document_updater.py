...
def test_document_updater():
    ...
    cv_path = '/home/ubuntu/cv_tailoring_project/data/Divyanshu - Resume_Template_ATS.docx'
    cover_letter_path = '/home/ubuntu/cv_tailoring_project/data/Cover Letter_Divyanshu .docx'
