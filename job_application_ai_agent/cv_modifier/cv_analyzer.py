...
from job_application_ai_agent.utils.helpers import ensure_directory_exists, sanitize_filename
...
class CVModifier:
    ...
    def process_multiple_jobs(self, jobs_df, output_dir=None):
        ...
        if output_dir is None:
            output_dir = os.path.join(os.getcwd(), "job_application_ai_agent", "outputs", "cvs")
