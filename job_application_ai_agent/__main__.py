...
def main():
    ...
    if args.command == 'web':
        ...
        from job_application_ai_agent.ui.app import app
        app.run(host=args.host, port=args.port, debug=args.debug)
        
    elif args.command == 'scrape':
        from job_application_ai_agent.scraper.linkedin import LinkedInScraper
        ...
        if jobs:
            ...
            if not output_file:
                ...
                output_dir = os.path.join(os.getcwd(), "job_application_ai_agent", "outputs", "jobs")
        ...
        from job_application_ai_agent.cv_modifier.cv_analyzer import CVAnalyzer, CVModifier, batch_process_jobs
        
        # Check if we're processing a single job or multiple jobs
        if args.jobs_file:
            # Process multiple jobs
            output_dir = args.output_dir or os.path.join(os.getcwd(), "job_application_ai_agent", "outputs", "cvs")
        ...
        from job_application_ai_agent.cv_modifier.cv_analyzer import batch_process_jobs
