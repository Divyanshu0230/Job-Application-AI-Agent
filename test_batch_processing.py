...
def main():
    ...
    try:
        ...
        from job_application_ai_agent.utils.helpers import ensure_directory_exists
    except ImportError:
    ...
    jobs_output_dir = os.path.join(os.getcwd(), "job_application_ai_agent", "outputs", "jobs")
    ...
    cv_output_dir = args.output_dir or os.path.join(os.getcwd(), "job_application_ai_agent", "outputs", "cvs")
